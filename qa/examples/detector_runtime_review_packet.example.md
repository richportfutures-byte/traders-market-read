...
Input file: `qa/examples/detector_runtime_calibrated_output.example.json`
...
- `ch02_structural_reference_levels` - Structural Reference Levels
  ...
  - Evidence summary: Measurements: note='Reference lattice only; behaviour at any reference is out of scope.', references_not_observed=[], references_observed={'rth_open_price': 5005.0, 'prior_day_high': 5020.0, 'prior_day_low': 4980.0}
...
- `ch03_value_migration_and_overlap` - Value Migration & Overlap
  ...
  - Confidence: `STRUCTURAL_OBSERVED`
  - Evidence summary: Measurements: current_value_area={'vah': 5012.0, 'val': 4998.0, 'poc': 5004.0}, note='Structural value movement only; directional meaning is out of scope.', prior_value_area={'vah': 5008.0, 'val': 4992.0, 'poc': 4998.0}, value_areas_overlap=True
